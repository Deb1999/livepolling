        ...
        <div class="wrapper">
            ...
            <form action="#">
                ...
                <section class="python">
                   ...
                   <p class="active" style="width:<?php echo $_SESSION['python']."%"; ?>;background-color:blue;color:white;"><?php echo $_SESSION['python']."%"; ?></p>
                </section>
                <section class="chash">
                   <input type="radio" name="language" value="C#"><label>C#</label>
                   <p class="active" style="width:<?php echo $_SESSION['csharp']."%"; ?>;background-color:green;color:white;"><?php echo $_SESSION['csharp']."%"; ?></p>
                </section>
                <section class="cplus">
                   <input type="radio" name="language" value="C++"><label>C++</label>
                   <p class="active" style="width:<?php echo $_SESSION['cplusplus']."%"; ?>;background-color:orange;color:black;"><?php echo $_SESSION['cplusplus']."%"; ?></p>
                </section>
